...
#[no_mangle]
pub extern fn _draw_square(x: u64, y: u64, w: u64) {
	draw_rectangle(x as f32, y as f32, w as f32, w as f32, GREEN);
}

#[no_mangle]
pub extern fn _clear(c: u64) {
	let color = match c {
		0 => BLACK,
		1 => WHITE,
		2 => GRAY,
...
#[no_mangle]
pub extern fn _key_down(k: u64) -> bool {
	let key = match k {
		0 => KeyCode::W,
		1 => KeyCode::A,
		2 => KeyCode::S,
...
#[no_mangle]
pub extern fn _draw_rect(x: u64, y: u64, w: u64, h: u64, c: u64) {
	let color = match c {
		0 => BLACK,
		1 => WHITE,
		2 => GRAY,
